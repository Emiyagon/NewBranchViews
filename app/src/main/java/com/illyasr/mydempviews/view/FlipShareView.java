...
public class FlipShareView extends View {
     ...
     * shareItem's width
     */
    private int mItemWidth = dip2px(145);
    /**
     * shareItem's height
     */
    private int mItemHeight = dip2px(39);
    /**
    ...
    private void drawFlipDownItem(Canvas canvas) {
        ...
        for (int i = 0; i < mItemList.size(); i++) {
            ...
            if (i == 0) {
                ...
                canvas.drawRect(mItemLeft, mFirstItemTop + i * mItemHeight,
                        mItemLeft + mItemWidth, mFirstItemTop + mItemHeight + i * mItemHeight, mPaint);
            }
            mItemRectList.add(new RectF(mItemLeft, mFirstItemTop + i * mItemHeight,
                    mItemLeft + mItemWidth, mFirstItemTop + mItemHeight + i * mItemHeight));
            drawTitle(canvas, i);
            drawIcon(canvas, i);
            mCamera.restore();
            canvas.restore();
    ...
    public FlipShareView setOnFlipClickListener(OnFlipClickListener onFlipClickListener) {
