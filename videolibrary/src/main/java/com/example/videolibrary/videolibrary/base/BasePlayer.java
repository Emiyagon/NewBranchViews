...
public abstract class BasePlayer implements IMediaPlayer {
    ...
    protected BasePlayer setVideoPath(String url, Map<String, String> headers) {
    ...
    //设置raw下视频的路径
    protected BasePlayer setVideoRawPath(@RawRes int rawId) {
        this.rawId = rawId;
        return this;
    }

    //设置assets下视频的路径
    protected BasePlayer setVideoAssetPath(String assetFileName) {
    ...
    public BasePlayer setOnStateChangeListener(OnStateChangedListener onStateChangeListener) {
        this.onStateChangeListener = onStateChangeListener;
        return this;
    }

    public BasePlayer setOnVideoSizeChangedListener(OnVideoSizeChangedListener onVideoSizeChangedListener) {
