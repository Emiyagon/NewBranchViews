...
public class DefaultCameraScan extends com.king.zxing.CameraScan {
    ...
    @Override
    public com.king.zxing.CameraScan setCameraConfig(CameraConfig cameraConfig) {
    ...
    @Override
    public com.king.zxing.CameraScan setAnalyzeImage(boolean analyze) {
        isAnalyze = analyze;
        return this;
    }

    @Override
    public com.king.zxing.CameraScan setAnalyzer(Analyzer analyzer) {
        mAnalyzer = analyzer;
        return this;
    }
    ...
    @Override
    public com.king.zxing.CameraScan setVibrate(boolean vibrate) {
        if(mBeepManager != null){
    ...
    @Override
    public com.king.zxing.CameraScan setPlayBeep(boolean playBeep) {
        if(mBeepManager != null){
    ...
    @Override
    public com.king.zxing.CameraScan setOnScanResultCallback(OnScanResultCallback callback) {
    ...
    @Override
    public com.king.zxing.CameraScan bindFlashlightView(@Nullable View v) {
        flashlightView = v;
        if(mAmbientLightManager != null){
    ...
    public com.king.zxing.CameraScan setDarkLightLux(float lightLux){
        if(mAmbientLightManager != null){
