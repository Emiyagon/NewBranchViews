package com.zhuosen.bilibili.biliplayer.zxing;
/*
...
import static com.zhuosen.bilibili.biliplayer.zxing.ViewfinderView.FrameGravity.CENTER;
...
public class ViewfinderView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        //初始化自定义属性信息
        TypedArray array = context.obtainStyledAttributes(attrs, com.king.zxing.R.styleable.ViewfinderView);
        maskColor = array.getColor(com.king.zxing.R.styleable.ViewfinderView_maskColor, ContextCompat.getColor(context, com.king.zxing.R.color.viewfinder_mask));
        frameColor = array.getColor(com.king.zxing.R.styleable.ViewfinderView_frameColor, ContextCompat.getColor(context, com.king.zxing.R.color.viewfinder_frame));
        cornerColor = array.getColor(com.king.zxing.R.styleable.ViewfinderView_cornerColor, ContextCompat.getColor(context, com.king.zxing.R.color.viewfinder_corner));
        laserColor = array.getColor(com.king.zxing.R.styleable.ViewfinderView_laserColor, ContextCompat.getColor(context, com.king.zxing.R.color.viewfinder_laser));

        labelText = array.getString(com.king.zxing.R.styleable.ViewfinderView_labelText);
        labelTextColor = array.getColor(com.king.zxing.R.styleable.ViewfinderView_labelTextColor, ContextCompat.getColor(context, com.king.zxing.R.color.viewfinder_text_color));
        labelTextSize = array.getDimension(com.king.zxing.R.styleable.ViewfinderView_labelTextSize, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,14f,getResources().getDisplayMetrics()));
        labelTextPadding = array.getDimension(com.king.zxing.R.styleable.ViewfinderView_labelTextPadding,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,24,getResources().getDisplayMetrics()));
        labelTextWidth = array.getDimensionPixelSize(com.king.zxing.R.styleable.ViewfinderView_labelTextWidth,0);
        labelTextLocation = TextLocation.getFromInt(array.getInt(com.king.zxing.R.styleable.ViewfinderView_labelTextLocation,0));

        frameWidth = array.getDimensionPixelSize(com.king.zxing.R.styleable.ViewfinderView_frameWidth,0);
        frameHeight = array.getDimensionPixelSize(com.king.zxing.R.styleable.ViewfinderView_frameHeight,0);

        laserStyle = LaserStyle.getFromInt(array.getInt(com.king.zxing.R.styleable.ViewfinderView_laserStyle,LaserStyle.LINE.mValue));
        gridColumn = array.getInt(com.king.zxing.R.styleable.ViewfinderView_gridColumn,20);
        gridHeight = (int)array.getDimension(com.king.zxing.R.styleable.ViewfinderView_gridHeight,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,40,getResources().getDisplayMetrics()));

        cornerRectWidth = (int)array.getDimension(com.king.zxing.R.styleable.ViewfinderView_cornerRectWidth,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,4,getResources().getDisplayMetrics()));
        cornerRectHeight = (int)array.getDimension(com.king.zxing.R.styleable.ViewfinderView_cornerRectHeight,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,16,getResources().getDisplayMetrics()));
        scannerLineMoveDistance = (int)array.getDimension(com.king.zxing.R.styleable.ViewfinderView_scannerLineMoveDistance,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,2,getResources().getDisplayMetrics()));
        scannerLineHeight = (int)array.getDimension(com.king.zxing.R.styleable.ViewfinderView_scannerLineHeight,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,5,getResources().getDisplayMetrics()));
        frameLineWidth = (int)array.getDimension(com.king.zxing.R.styleable.ViewfinderView_frameLineWidth,TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,1,getResources().getDisplayMetrics()));
        scannerAnimationDelay = array.getInteger(com.king.zxing.R.styleable.ViewfinderView_scannerAnimationDelay,20);
        frameRatio = array.getFloat(com.king.zxing.R.styleable.ViewfinderView_frameRatio,0.625f);
        framePaddingLeft = array.getDimension(com.king.zxing.R.styleable.ViewfinderView_framePaddingLeft,0);
        framePaddingTop = array.getDimension(com.king.zxing.R.styleable.ViewfinderView_framePaddingTop,0);
        framePaddingRight = array.getDimension(com.king.zxing.R.styleable.ViewfinderView_framePaddingRight,0);
        framePaddingBottom = array.getDimension(com.king.zxing.R.styleable.ViewfinderView_framePaddingBottom,0);
        frameGravity = FrameGravity.getFromInt(array.getInt(com.king.zxing.R.styleable.ViewfinderView_frameGravity, CENTER.mValue));
        array.recycle();
